...
int main(){
	...
	do {
		...
		} while (choice != 5 && choice !=4); //continue while choice is not exit or payment
		
		printf("Are you sure you want to exit? (y/n):" );
		scanf("%c", &continueChoice);
		
	} while (continueChoice == 'n' || continueChoice == 'N'); //continue outer Loop while user
